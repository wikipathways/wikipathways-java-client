...
/**
 * A client API that provides access to the WikiPathways NEW REST webservice.
 * 
 * @author yihangx
 *
 */
public class WikiPathwaysClient {
	...
	public WSSearchResultLiterature[] findPathwaysByLiterature(String query) throws RemoteException {
		...
		if (r == null)
			r = new WSSearchResultLiterature[0];
		return r;
	}
